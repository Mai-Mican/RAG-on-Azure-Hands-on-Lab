...
def is_service_available(flight: bool):
    ...
    return {
                "content_harm_service": content_harm_service,
                "groundedness_service": False # Disable groundedness service as requested by PM
            }
...
def validate_safety_metric_input(
    ...
    valid_input_safety = any([metric in validated_input for metric in Metric.CONTENT_HARM_METRICS])
