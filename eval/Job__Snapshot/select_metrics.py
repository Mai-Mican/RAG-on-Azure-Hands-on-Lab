...
def select_metrics(metrics: str) -> Dict[str, bool]:
    ...
    supported_legal_security_metrics = Metric.LEGAL_SECURITY_METRICS
    supported_metrics = supported_quality_metrics | supported_safety_metrics | supported_legal_security_metrics
    ...
    metric_selection_dict[MetricGroup.LEGAL_SECURITY_METRICS] = \
        select_metrics_from_metric_list(metrics.lower(),
                                        supported_legal_security_metrics)
